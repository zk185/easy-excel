...
public class ExcelWriter {
    ...
    public ExcelWriter write0(List<? extends BaseRowModel> data, Sheet sheet, int startRow, int startCol, int flag) {
        excelBuilder.addContent(data, sheet, startRow, startCol, flag);
        return this;
    }
